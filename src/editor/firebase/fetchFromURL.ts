/**
 * Fetches a file from a URL and returns the ArrayBuffer
 ...
 */
export default function fetchFromURL(url: string, onProgress?: (percent: number) => void): Promise<ArrayBuffer> {
