            ...
            >
                <div style={{ margin: 15 }}>
                    ...
                    <ol>
                        ...
                        <li style={{ margin: 5 }}>
                            Maps cannot state or suggest that your mod is official, licensed, or otherwise authorized by
                            Innersloth.
                        </li>
                        <li style={{ margin: 5 }}>
                    ...
                    <p>
                        Both LevelImposter and InnerSloth reserve the right to modify or delete your map or account at
                        any time for any reason.
                        <br /><br />
                        By pressing "I Agree", you are agreeing to abide by these rules and to be bound by the terms of
                        the Among Us Mod Policy.
                        <br /><br />
                        A copy of these rules can be found at <a href="https://levelimposter.net/#/policy"
                                                                 target={"_blank"}
                                                                 rel="noreferrer">LevelImposter.net/#/Policy</a>
                    </p>
