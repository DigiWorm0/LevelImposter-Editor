...
import getGlobalZFromLocalZ from "../utils/getGlobalZFromLocalZ";
import {UNITY_SCALE} from "@/types/amongus/Constants";
import useElementOpacity from "./useElementOpacity";
import degToRad from "@shared/math/degToRad";
import useMapElementRef from "./useMapElementRef";
...
import {getSelectOperationFromEvent} from "@/rendering/canvas2/utils/getSelectOperationFromEvent";
import mapElementEventEmitter from "./mapElementEventEmitter";
...
export default function MapElement(props: MapElementProps) {
    const {isGridSnapEnabled, gridSnapResolution} = useAtomValue(settingsAtom);
